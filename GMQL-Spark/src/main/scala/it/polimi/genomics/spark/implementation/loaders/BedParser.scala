...
/**
  ...
  *
  */
object NarrowPeakParser extends GMQLLoader[(Long, String), Option[DataTypes.GRECORD], (Long, String), Option[DataTypes.MetaType]] with java.io.Serializable {
  ...
  override def region_parser(t: (Long, String)): Option[(GRecordKey, Array[GValue])] = {
    ...
    try {
      ...
      Some(
        ...
        case e: Throwable =>
          logger.warn(e.getMessage)
          logger.warn("Chrom: " + 0 + "\tStart: " + 1 + "\tStop: " + 2 + "\tstrand: " + 5);
          logger.warn("Values: " + schema + " \n" + "This line can not be casted (check the spacing): \n\t\t" + t)
          None
      }
  }
