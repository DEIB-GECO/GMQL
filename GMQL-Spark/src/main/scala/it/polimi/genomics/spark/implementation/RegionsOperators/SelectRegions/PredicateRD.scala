...
import it.polimi.genomics.core.DataStructures.{RegionCondition, MetaOperator}
...
object PredicateRD {
  ...
  def applyRegionPredicateEQ(value : Any, input : GValue, sampleID : Long): Boolean = {
    ...
    value match {
      case metaList : Array[MetaType] =>
        try{applyRegionPredicateEQ( castDoubleOrString(metaList.filter(_._1.equals(sampleID))(0)._2._2), input,sampleID)} catch {case e: IndexOutOfBoundsException => false}
  ...
  def applyRegionPredicateNOTEQ(value : Any, input : GValue, sampleID : Long): Boolean = {
    value match {
      case metaList : Array[MetaType] =>
        try{applyRegionPredicateNOTEQ(castDoubleOrString(metaList.filter(_._1.equals(sampleID))(0)._2._2), input,sampleID)} catch {case e: IndexOutOfBoundsException => false}
      case value : Int => !input.asInstanceOf[GDouble].v.equals(value.toDouble)
      case value : Long => !(input.asInstanceOf[GDouble].v.equals( value.toDouble))
      case value : Double => !input.asInstanceOf[GDouble].v.equals(value.toDouble)
      case value : String => !input.asInstanceOf[GString].v.equals(value)
  ...
  def applyRegionPredicateLT(value : Any, input : GValue, sampleID : Long): Boolean = {
    value match {
      case metaList : Array[MetaType] =>
        try {applyRegionPredicateLT(castDoubleOrString(metaList.filter(_._1.equals(sampleID))(0)._2._2), input, sampleID)} catch {case e : IndexOutOfBoundsException => false}
  ...
  def applyRegionPredicateLTE(value : Any, input : GValue, sampleID : Long): Boolean = {
    value match {
      case metaList : Array[MetaType] =>
        try {applyRegionPredicateLTE(castDoubleOrString(metaList.filter(_._1.equals(sampleID))(0)._2._2), input,sampleID)} catch {case e : IndexOutOfBoundsException => false}
  ...
  def applyRegionPredicateGT(value : Any, input : GValue, sampleID : Long): Boolean = {
    value match {
      case metaList : Array[MetaType] =>
        try{applyRegionPredicateGT(castDoubleOrString(metaList.filter(_._1.equals(sampleID))(0)._2._2), input, sampleID)} catch {case e: IndexOutOfBoundsException => false}
      case value : Int => input.asInstanceOf[GDouble].v > value.toDouble
      case value : Long => input.asInstanceOf[GDouble].v > value.toDouble
      case value : Double => input.asInstanceOf[GDouble].v > value.toDouble
      case value : String =>
  ...
  def applyRegionPredicateGTE(value : Any, input : GValue, sampleID : Long): Boolean = {
    value match {
      case metaList : Array[MetaType] =>
        try{applyRegionPredicateGTE(castDoubleOrString( metaList.filter(_._1.equals(sampleID))(0)._2._2.trim.toDouble), input,sampleID)} catch {case e: IndexOutOfBoundsException => false}
      case value : Int => input.asInstanceOf[GDouble].v >= value.toDouble
      case value : Long => input.asInstanceOf[GDouble].v >= value.toDouble
      case value : Double => input.asInstanceOf[GDouble].v >= value.toDouble
      case value : String =>
