...
object App {
  ...
  def main(args : Array[String]) {
    ...
    */
    ...
    val dataAsTheyAre = server READ ex_data_path USING BedScoreParser2
    val optionalDS = server READ ex_data_path_optional USING BedScoreParser2


    val what = args(1).toInt
    //val what = 0 //
    //val what = 1 //
    //val what = 2 //
    //val what = 3 //
