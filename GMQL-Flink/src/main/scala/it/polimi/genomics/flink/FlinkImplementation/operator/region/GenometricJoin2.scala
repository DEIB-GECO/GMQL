          ...
          (r, e, out : Collector[(Long, Long, String, Long, Long, Char, Array[GValue], Long, Long, Char, Array[GValue], Long)]) => {
            ...
            //((e._1.equals(e._3)) || (r._8.equals(r._9)))
              (
                ...
                &&
                // valid group
                ( !groups.isDefined || groups.get.contains((r._1, e._4)) )
            ){
              ...
              */
              ...
              out.collect(hashId, r._7, r._2, r._3, r._4, r._5, r._6, e._6, e._7, e._8, e._9, distance)
            }
          }
        }
        .withForwardedFieldsFirst("6->1;1->2;2->3;3->4;4->5")
        ...
        if (minDistanceParameter.isDefined) {
          firstRound
            ...
            .reduceGroup((i : Iterator[(Long, Long, String, Long, Long, Char, Array[GValue], Long, Long, Char, Array[GValue], Long)], out : Collector[(Long, Long, String, Long, Long, Char, Array[GValue], Long, Long, Char, Array[GValue], Long)]) => {
              ...
              */
            }).withForwardedFields("0;1;2;3;4;5;7;8;9;11")
        } else {
          firstRound
        }
  ...
  */
  ...
  def binAnchor(ds : DataSet[(Long, String, Long, Long, Char, Array[GValue])], firstRound : JoinExecutionParameter, secondRound : JoinExecutionParameter, binSize : Long, max : Long) : DataSet[(Long, String, Long, Long, Char, Array[GValue], Long, Int, Int)] = {
    ...
    ds.flatMap((r : (Long, String, Long, Long, Char, Array[GValue]), out : Collector[(Long, String, Long, Long, Char, Array[GValue], Long, Int, Int)]) => {
      ...
      val start1 : Long = if(!firstRound.stream.isDefined || (firstRound.stream.get.equals(r._5)) || (r._5.equals('*') && firstRound.stream.get.equals('+')) ) r._3 - maxDistance else r._4
      ...
      val end2 : Long = if(!firstRound.stream.isDefined || (!firstRound.stream.get.equals(r._5)) || (r._5.equals('*') && firstRound.stream.get.equals('-')) ) r._4 + maxDistance else  r._3
