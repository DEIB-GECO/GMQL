...
//
//
////import it.polimi.genomics.repository.util.FS_Utilities;
...
//            if (HDFSfile) {
////                Configuration conf = FS_Utilities.getInstance().gethdfsConfiguration();
...
////                conf.addResource(new org.apache.hadoop.fs.Path(FS_Utilities.getInstance().CoreConfigurationFiles));
////                conf.addResource(new org.apache.hadoop.fs.Path(FS_Utilities.getInstance().HDFSConfigurationFiles));
//                FileSystem fs = FileSystem.get(conf);
//                reader = new BufferedReader(
